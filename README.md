...
3. Preencha os campos de cada exercício e clique em **“Calcular”** ou **“Executar”**.
...
6. Sucessor de um número.  
7. Antecessor de um número.  
8. Área de um retângulo.  
9. Área de um triângulo.  
10. Área de um quadrado.  
11. Área de um círculo (usando o raio).  
12. Média aritmética de três notas.  
13. Dobro de um número inteiro.  
14. Parte inteira de um número real.  
15. Cálculo do IMC (Índice de Massa Corporal).  
16. Desconto de 10% em um produto.  
17. Média das idades de três pessoas.  
18. Conversão de metros para centímetros e milímetros.  
19. Cálculo da hipotenusa (Teorema de Pitágoras).
